...
public class AppManagementFunction
{
    ...
    {
        var authResult = await CheckAdminAsync(req);
    ...
    // Admin-Check: 401 wenn nicht authentifiziert, 403 wenn kein Admin
    private async Task<IActionResult?> CheckAdminAsync(HttpRequest req)
    {
